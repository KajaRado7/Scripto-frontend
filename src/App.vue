        ...
        <nav class="leftNav">
          <router-link to="/subject">
            <a href="#subject" style="display:flex;align-items:center">
              ...
              <span class="leftNavText">Subject</span>
            </a>
          </router-link>
          <router-link to="/study">
            <a href="#study" style="display:flex;align-items:center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="40"
              ...
              <span class="leftNavText">Study</span>
            </a>
          </router-link>
...
.leftNav {
  ...
  width: 240px;
  position: fixed;
  z-index: -1; // LeftNav ide iza TopNav-a
  top: 0;
  left: 0;
